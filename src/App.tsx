...
export default function App(){
 ...
 return <div className="app-shell"><Seo title={pageTitles[location.pathname] ?? site.title}/><Navbar dark={dark} onToggle={()=>setDark(v=>!v)}/><main><Routes><Route path="/" element={<Home/>}/><Route path="/about" element={<About/>}/><Route path="/skills" element={<Skills/>}/><Route path="/projects" element={<Projects/>}/><Route path="/projects/:slug" element={<ProjectDetail/>}/><Route path="/services" element={<Services/>}/><Route path="/experience" element={<Experience/>}/><Route path="/case-studies" element={<CaseStudies/>}/><Route path="/blog" element={<Blog/>}/><Route path="/media" element={<Media/>}/><Route path="/contact" element={<Contact/>}/><Route path="/resume" element={<Resume/>}/><Route path="/privacy" element={<Privacy/>}/><Route path="/terms" element={<Terms/>}/><Route path="/accessibility" element={<Accessibility/>}/><Route path="/start-a-project" element={<ProjectIntake/>}/><Route path="/ai-assistant" element={<PortfolioAssistant fullPage/>}/><Route path="*" element={<Home/>}/></Routes></main><FloatingContact/><Footer/></div>
}
