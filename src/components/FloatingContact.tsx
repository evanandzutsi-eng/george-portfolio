import {useState} from 'react';import {Mail,Phone,MessageCircle,Send,Linkedin,X} from 'lucide-react';import {site,isPlaceholder} from '../data/site'
export function FloatingContact(){
 const [open,setOpen]=useState(false)
 const items=[
  {label:'WhatsApp',icon:MessageCircle,url:'https://wa.me/2348100362060'},
